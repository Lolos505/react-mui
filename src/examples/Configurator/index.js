...
function Configurator() {
  ...
  return (
    <ConfiguratorRoot variant="permanent" ownerState={{ openConfigurator }}>
      ...
      >
        <SoftBox>
          <SoftTypography variant="h5">Drink Buddy Configurator</SoftTypography>
      ...
      <SoftBox pt={1.25} pb={3} px={3}>
        <SoftBox>
          <SoftTypography variant="h6">Side navbar Colors</SoftTypography>
        ...
        <SoftBox mt={3} lineHeight={1}>
          <SoftTypography variant="h6">Side navbar Type</SoftTypography>
          <SoftTypography variant="button" color="text" fontWeight="regular">
            Choose between 2 different side navbar types.
          </SoftTypography>
